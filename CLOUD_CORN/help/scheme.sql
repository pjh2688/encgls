...
CREATE TABLE KTAPI_COMM (
	...
	KTAPI_RES VARCHAR (4096) NULL COMMENT 'KTAPI_응답전문',
...
CREATE TABLE SERVICE_CLOUD (
	...
	CLOUD_DB_VMIP VARCHAR (20) NULL COMMENT '클라우드_DBVM_내부VMIP',
	CLOUD_L4_VMIP VARCHAR (20) NULL COMMENT '클라우드_L4내부IP',
	CLOUD_WASVM_DEFAULT_VMIP VARCHAR (20) NULL COMMENT '클라우드_WASVM_내부VMIP',
	...
	CLOUD_DBVM_OSINFO VARCHAR (200) NULL COMMENT '클라우드_DBVM_서버사양정보',
	CLOUD_DBVM_PASSWORD VARCHAR (50) NULL COMMENT '클라우드_DBVM_패스워드',
	CLOUD_DBVM_TEMPLATENAME VARCHAR (50) NULL COMMENT '클라우드_DBVM_템플릿이름',
	CLOUD_WASVM_TEMPLATENAME VARCHAR (50) NULL COMMENT '클라우드_WASVM_템플릿이름',
	CLOUD_WASVM_PASSWORD VARCHAR (50) NULL COMMENT '클라우드_WASVM_패스워드',
	CLOUD_WASVM_OSINFO VARCHAR (200) NULL COMMENT '클라우드_WASVM_서버사양정보',
